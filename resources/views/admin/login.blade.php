        ...
        <nav class="navbar navbar-default navbar-static-top">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    <img style="margin: 25px" src="" alt="man-we-are">
                </div>
...
s
    ...
    <span style="float:left; margin:10px"><i class="fa fa-copyright" aria-hidden="true"></i>Created by Project kovu API 2019 </span>
    </div>
